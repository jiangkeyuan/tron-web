<template>
    <div class="recharge">
        <DashBord>
            <div class="recharge-content-history" @click="gotoRechargeLog">充值记录</div>
            <el-tabs v-model="activeName">
                <el-tab-pane label="DAPP" name="first">
                    <div class="recharge-content">
                        ...
                        <el-button type="primary" class="recharge-content-button">充 值</el-button>
                ...
                <el-tab-pane label="转账充值" name="second">
                    <div class="recharge-content">
                        ...
                        <div class="recharge-content-address">
                            ...
                            <el-icon @click="copyEnd" class="recharge-content-address-icon" color="#294aa5"><CopyDocument /></el-icon>
                        </div>
                        <div class="recharge-content-two-text">
                            <span>*</span>
                            <span class="recharge-content-two-text-child"> 请使用波场浏览器或手机钱包进行转账</span>
                        </div>
                        <div class="recharge-content-two-text">
                            <span>*</span>
                            <span class="recharge-content-two-text-child"> 请核对钱包地址后再转账,若转账后没查到充值金额,可联系客服找回</span>
                        </div>
                        <div class="recharge-content-two-text">
                            <span>*</span>
