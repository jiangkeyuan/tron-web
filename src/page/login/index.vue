  ...
  <div class="login" v-loading.fullscreen.lock="fullscreenLoading">
    ...
    <div class="login-content">
      ...
      <div class="login-form-main" v-if="type === '3'">
        ...
        <el-button type="primary" color="#c53027" class="login-form" @click="() => changeType('0')" round>{{ $t('"LOGIN-022') }}</el-button>
      </div>
      ...
      <LoginForm v-else v-model:data.sync="userInfo" :type="type" ref="loginFormRef">
        <div class="login-content-login" v-if="type === '0'">
          <el-button type="primary" color="#c53027" class="login-content-button" @click="login">{{ $t("LOGIN-005") }}</el-button>
          <div class="login-content-login-text">
            <el-button type="primary" text class="login-content-login-text-button"
              @click="() => changeType('1')">{{ $t("LOGIN-006") }}</el-button>
            <el-button type="primary" text class="login-content-login-text-button"
              @click="() => changeType('2')">{{ $t("LOGIN-007") }}</el-button>
          </div>
        ...
        <div v-if="type === '1'">
          <div>
            <el-button @click="() => register()" type="primary" color="#c53027"
              class="login-content-button">{{ t('LOGIN-011') }}</el-button>
          </div>
          <div>
        ...
        <div v-if="type === '2'" class="login-content-login-text-other">
          <div>
            <el-button type="primary" color="#c53027" class="login-content-button"
              @click="() => forgetpwds()">{{ $t("LOGIN-015") }}</el-button>
          </div>
          <div>
        ...
        <div v-if="type === '5'" class="login-content-login-text-other">
          <div>
            <el-button type="primary" color="#c53027" class="login-content-button"
              @click="handleSetemailVerify">{{ $t('LOGIN-039') }}</el-button>
          </div>
        </div>
        <div v-if="type === '6'" class="login-content-login-text-other">
          <div>
            <el-button type="primary" color="#c53027" class="login-content-button"
              @click="handleResetPwd">{{ $t('LOGIN-040') }}</el-button>
          </div>
          <div>
            <el-button class="login-content-button" @click="() => changeType('0')">{{ $t('LOGIN-012') }}</el-button>
          </div>
    ...
    <el-dialog append-to-body v-model="dialogTableVisible" width="450">
      <div class="custom-modal-centent">
        ...
        <el-button @click="tron_register" type="primary" color="#c53027" class="login-content-button">{{ $t("LOGIN-027") }}</el-button>
      </div>
    </el-dialog>
    ...
    <el-dialog append-to-body :title="$t('LOGIN-023')" v-model="dialogVisibleReset" width="450">
      <div class="dialogReset">
        ...
        <el-button @click="() => resetEmailsSearch()" type="primary" color="#c53027"
          class="reset-content-button">{{ $t('LOGIN-024') }}</el-button>
      </div>
    </el-dialog>
